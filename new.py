...
def delete_index(api_key, index_name="multimedia-index"):
    if 'pinecone_initialized' in st.session_state and 'index' in st.session_state:
        try:
            ...
            # Clear session state related to the index
            del st.session_state.index
            st.session_state.pop(f"{index_name}_created", None)
        except PineconeException as e:
